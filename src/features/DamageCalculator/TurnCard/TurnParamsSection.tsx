		...
		<>
			<Space.Compact>
				...
				<Select
					...
					onSelect={(value) =>
						setTurnParams((prev) => ({ ...prev, classAffinity: value }))
					}
				...
				<Select
					...
					onSelect={(value) =>
						setTurnParams((prev) => ({ ...prev, attributeAffinity: value }))
					}
					options={enemyClassOptions}
					style={{ width: 68 }}
				/>
				<InputNumber
					...
					onChange={(value) =>
						setTurnParams((prev) => ({ ...prev, targetDamage: value }))
					}
					type="number"
					addonBefore="目標ダメージ"
					style={{ width: 240 }}
			...
			<CollapseWithOutHeader isActive={isRequiredNpStarCalc}>
				<Space.Compact>
					<InputNumber
						...
						onChange={(value) =>
							setTurnParams((prev) => ({ ...prev, enemyNpCharge: value }))
						}
						type="number"
					...
					<InputNumber
						...
						onChange={(value) =>
							setTurnParams((prev) => ({ ...prev, dsr: value }))
						}
						type="number"
