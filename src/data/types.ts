...
export interface DamageCalcFormValue {
  ...
  craftEssenceAtk: number | null;
  npColor: CardColor;
  npValue: number | null;
  footprintB: number | null;
  footprintA: number | null;
  footprintQ: number | null;
  npGain: number | null;
  starRate: number | null;
  hitCountN: number | null;
  hitCountB: number | null;
  hitCountA: number | null;
  hitCountQ: number | null;
  hitCountEX: number | null;
  startingBuffs: Buff[];
  turns: TurnFormValue[];
  isColored: boolean;
